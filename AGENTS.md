...
3. `skill/SKILL.md` — skill-facing usage contract
4. `src/hermes_codex_image_skill/cli.py` — CLI entrypoint
5. `src/hermes_codex_image_skill/codex_runner.py` — actual runtime logic
